...
url = "https://www.martindale.com/areas-of-law/workers-compensation-lawyers/"
...
response = requests.request("GET", url, headers=headers, data=payload, impersonate='chrome136')
